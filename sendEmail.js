...
exports.sendResetRequest = async function (email, uniqueString) {
    ...
    let info = await transporter.sendMail({
        ...
        html: "<h1>Health-n-Wellness Password Reset Request!</h1><b>Please click on the link to verify your account <a href=" + "http://localhost:3000/pass-reset" + apiRoute + "> here </a></b></b>", // html body
    });
